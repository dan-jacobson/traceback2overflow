...
define([
    ...
    var mod_name = 'traceback2overflow';
    ...
    var apply_patches = function () {
        ...
        outputarea.OutputArea.prototype.append_error = function (json) {
            // first part is just a copy of the original, but keeping a reference to inserted_text
            var inserted_text;
